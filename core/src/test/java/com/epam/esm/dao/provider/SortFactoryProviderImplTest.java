...
class SortFactoryProviderImplTest {
	...
	void provideDateAscSortQueryFragmentForDateAscRequest1() {
		assertEquals(dateAscResponseExpected, sortFactoryProvider.provideSortQueryFragment(dateAscRequest1));
	}

	@Test
	void provideDateAscSortQueryFragmentForDateAscRequest2() {
		assertEquals(dateAscResponseExpected, sortFactoryProvider.provideSortQueryFragment(dateAscRequest2));
	}

	@Test
	void provideDateAscSortQueryFragmentForDateAscRequest3() {
		assertEquals(dateAscResponseExpected, sortFactoryProvider.provideSortQueryFragment(dateAscRequest3));
	}

	@Test
	void provideDateDescSortQueryFragmentForDateDescRequest1() {
		assertEquals(dateDescResponseExpected, sortFactoryProvider.provideSortQueryFragment(dateDescRequest1));
	}

	@Test
	void provideDateDescSortQueryFragmentForDateDescRequest2() {
		assertEquals(dateDescResponseExpected, sortFactoryProvider.provideSortQueryFragment(dateDescRequest2));
	}

	@Test
	void provideDateDescSortQueryFragmentForDateDescRequest3() {
		assertEquals(dateDescResponseExpected, sortFactoryProvider.provideSortQueryFragment(dateDescRequest3));
	}

	@Test
	void provideNameAscSortQueryFragmentForNameAscRequest1() {
		assertEquals(nameAscResponseExpected, sortFactoryProvider.provideSortQueryFragment(nameAscRequest1));
	}

	@Test
	void provideNameAscSortQueryFragmentForNameAscRequest2() {
		assertEquals(nameAscResponseExpected, sortFactoryProvider.provideSortQueryFragment(nameAscRequest2));
	}

	@Test
	void provideNameAscSortQueryFragmentForNameAscRequest3() {
		assertEquals(nameAscResponseExpected, sortFactoryProvider.provideSortQueryFragment(nameAscRequest3));
	}
