...
class SearchProviderImplTest {
	...
	private final String basicQuery = "SELECT gift_certificate.id, gift_certificate.name, description, price, duration,"
			+ " createDate, lastUpdateDate FROM gift_certificate";
	private final String addTagName = " JOIN gift_certificate_tag ON gift_certificate.id ="
			+ " gift_certificate_tag.gift_certeficate_id JOIN tag ON"
	...
	// addDescriptionNotFirst + sortQuery,
	// searchProvider.provideQuery(tagName, certificateName, description, sort));
	// }
	//
	// @Test
	// void
	// provideQueryWithTagNameCertificateNameAndDescriptionShouldReturnValidQuery()
	// {
	// assertEquals(basicQuery + addTagName + addCertificateNameNotFirst +
	// addDescriptionNotFirst,
	...
	// assertEquals(basicQuery + addTagName, searchProvider.provideQuery(tagName,
	// null, null, null));
	// }
	//
	// @Test
