...
class SearchProviderImplTest {
    ...
    void provideQueryWithTagNameOnlyShouldReturnValidQuery() {
        assertEquals(basicQuery + addTagName,
                searchProvider.provideQuery(tagName, null, null, null));
    }
    ...
    void provideQueryWithAllNullParamsShouldReturnValidQuery() {
        assertEquals(basicQuery,
                searchProvider.provideQuery(null, null, null, null));
    }
