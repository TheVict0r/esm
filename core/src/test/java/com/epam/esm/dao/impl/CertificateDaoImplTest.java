...
class CertificateDaoImplTest {
	...
	void searchShouldReturnAllCertificatesIfAllValuesNull() {
		...
		List<Certificate> allCertificatesFound = certificateDao.getCertificates(null, null, null, null, 1, 10);
	...
	void searchByCertificateNameShouldReturnListWithOneCertificate() {
		...
		List<Certificate> certificateFound = certificateDao.getCertificates(null, "name 4 test", null, null, 1, 10);
	...
	void searchByTagNameAndSortDescShouldReturnCertificateList() {
		...
		List<Certificate> tagAndSortFound = certificateDao.getCertificates(List.of("Tag 1 test"), null, null,
				"NAME_DESC", 1, 10);
