 ...
 *
 * <p>Entities from tag1 to tag 10 and certificate1 to certificate9 are equals to testing database
 */
@Component
@Getter
public class TestEntityProvider {
  ...
  private List<TagDto> allTagsDtoList =
      new ArrayList<>(
          List.of(
              new TagDto[] {
                tag1dto, tag10dto, tag2dto, tag3dto, tag4dto, tag5dto, tag6dto, tag7dto, tag8dto,
                tag9dto
              }));
  ...
  private Certificate certificate1withTags =
      new Certificate()
          .builder()
          .id(1L)
          .name("name 1 test")
  ...
  private Certificate certificate2withTags =
      new Certificate()
          .builder()
          .id(2L)
          .name("name 2 test")
  ...
  private Certificate certificate3withTags =
      new Certificate()
          .builder()
          .id(3L)
          .name("name 3 test")
  ...
  private Certificate certificate4withTags =
      new Certificate()
          .builder()
          .id(4L)
          .name("name 4 test")
  ...
  private Certificate certificate5 =
      new Certificate()
          .builder()
          .id(5L)
          .name("name 5 test")
  ...
  private Certificate certificate5withTags =
      new Certificate()
          .builder()
          .id(5L)
          .name("name 5 test")
  ...
  private Certificate certificate6 =
      new Certificate()
          .builder()
          .id(6L)
          .name("name 6 test")
  ...
  private Certificate certificate6withTags =
      new Certificate()
          .builder()
          .id(6L)
          .name("name 6 test")
  ...
  private Certificate certificate7 =
      new Certificate()
          .builder()
          .id(7L)
          .name("name 7 test")
  ...
  private Certificate certificate7withTags =
      new Certificate()
          .builder()
          .id(7L)
          .name("name 7 test")
  ...
  private Certificate certificate8 =
      new Certificate()
          .builder()
          .id(8L)
          .name("name 8 test")
  ...
  private Certificate certificate8withTags =
      new Certificate()
          .builder()
          .id(8L)
          .name("name 8 test")
  ...
  private Certificate certificate9 =
      new Certificate()
          .builder()
          .id(9L)
          .name("name 9 test")
  ...
  private Certificate certificate9withTags =
      new Certificate()
          .builder()
          .id(9L)
          .name("name 9 test")
  ...
  private Certificate certificateForCreationInService =
      new Certificate()
          .builder()
  ...
  private Certificate certificateForCreationInDao =
      new Certificate()
          .builder()
          .name("name 10 test created")
          .description("description 10 created")
  ...
  private Certificate certificateCreated =
      new Certificate()
          .builder()
          .id(10L)
          .name("name 10 test created")
  ...
  private Certificate certificateForReplacementInService =
      new Certificate()
          .builder()
          .id(1L)
          .name("name replaced")
  ...
  private Certificate certificateAfterReplacementInService =
      new Certificate()
          .builder()
          .id(1L)
          .name("name replaced")
  ...
  private Certificate certificateForReplacementInDao =
      new Certificate()
          .builder()
          .id(1L)
          .name("name replaced")
  ...
  private Certificate certificateWithWrongIdForReplacementInDao =
      new Certificate()
          .builder()
          .id(1_000_000L)
          .name("name replaced")
  ...
  private CertificateDto certificate1dto =
      new CertificateDto()
          .builder()
          .id(1L)
          .name("name 1 test")
  ...
  private CertificateDto certificate1withTagsDto =
      new CertificateDto()
          .builder()
          .id(1L)
          .name("name 1 test")
  ...
  private CertificateDto certificate2dto =
      new CertificateDto()
          .builder()
          .id(2L)
          .name("name 2 test")
  ...
  private CertificateDto certificate2withTagsDto =
      new CertificateDto()
          .builder()
          .id(2L)
          .name("name 2 test")
  ...
  private CertificateDto certificate3dto =
      new CertificateDto()
          .builder()
          .id(3L)
          .name("name 3 test")
  ...
  private CertificateDto certificate3withTagsDto =
      new CertificateDto()
          .builder()
          .id(3L)
          .name("name 3 test")
  ...
  private CertificateDto certificate4dto =
      new CertificateDto()
          .builder()
          .id(4L)
          .name("name 4 test")
  ...
  private CertificateDto certificate4withTagsDto =
      new CertificateDto()
          .builder()
          .id(4L)
          .name("name 4 test")
  ...
  private CertificateDto certificate5dto =
      new CertificateDto()
          .builder()
          .id(5L)
          .name("name 5 test")
  ...
  private CertificateDto certificate5withTagsDto =
      new CertificateDto()
          .builder()
          .id(5L)
          .name("name 5 test")
  ...
  private CertificateDto certificate6dto =
      new CertificateDto()
          .builder()
          .id(6L)
          .name("name 6 test")
  ...
  private CertificateDto certificate6withTagsDto =
      new CertificateDto()
          .builder()
          .id(6L)
          .name("name 6 test")
  ...
  private CertificateDto certificate7dto =
      new CertificateDto()
          .builder()
          .id(7L)
          .name("name 7 test")
  ...
  private CertificateDto certificate7withTagsDto =
      new CertificateDto()
          .builder()
          .id(7L)
          .name("name 7 test")
  ...
  private CertificateDto certificate8dto =
      new CertificateDto()
          .builder()
          .id(8L)
          .name("name 8 test")
  ...
  private CertificateDto certificate8withTagsDto =
      new CertificateDto()
          .builder()
          .id(8L)
          .name("name 8 test")
  ...
  private CertificateDto certificate9dto =
      new CertificateDto()
          .builder()
          .id(9L)
          .name("name 9 test")
  ...
  private CertificateDto certificate9withTagsDto =
      new CertificateDto()
          .builder()
          .id(9L)
          .name("name 9 test")
  ...
  private CertificateDto certificateForCreationDto =
      new CertificateDto()
          .builder()
          .name("name 10 test created")
          .description("description 10 created")
  ...
  private CertificateDto certificateWithIdForCreationDto =
      new CertificateDto()
          .builder()
          .id(99L)
  ...
  private CertificateDto certificateCreatedDto =
      new CertificateDto()
          .builder()
          .id(10L)
          .name("name 10 test created")
  ...
  private CertificateDto certificateForReplacementDto =
      new CertificateDto()
          .builder()
          .id(1L)
          .name("name replaced")
  ...
  private CertificateDto certificateAfterReplacementDto =
      new CertificateDto()
          .builder()
          .id(1L)
          .name("name replaced")
  ...
  private List<Certificate> allCertificatesList =
      new ArrayList<>(
          List.of(
              new Certificate[] {
                certificate1,
  ...
  private List<CertificateDto> allCertificatesDtoList =
      new ArrayList<>(
          List.of(
              new CertificateDto[] {
                certificate1dto,
