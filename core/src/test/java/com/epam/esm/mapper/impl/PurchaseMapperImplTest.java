...
class PurchaseMapperImplTest {
	...
	void convertToEntityShouldReturnEntity() {
		PurchaseDto purchaseDto = new PurchaseDto(1L, 2L, LocalDateTime.parse("2022-04-25 13:11:03.635", formatter), 99,
				null);
		Purchase expectedPurchase = new Purchase(1L, 2L, LocalDateTime.parse("2022-04-25 13:11:03.635", formatter), 99,
				null);
	...
	void convertToDtoShouldReturnDto() {
		...
		PurchaseDto expectedPurchaseDto = new PurchaseDto(1L, 2L,
				LocalDateTime.parse("2022-04-25 13:11:03.635", formatter), 99, null);
