 ...
 *
 * @param <E> DTO for CRUD operations
 */
public interface BasicService<E> {
   ...
   *
   * @param dto DTO object with data for entity need to be created
   ...
   * @return <b>DTO</b> of entity, returned by the corresponding {@code DAO level} method
   */
  E findById(Long id);

  /**
   * Replaces the particular entity's data, the entity selected by provided <b>ID</b>.
   *
   * @param id entity's <b>ID</b>
   * @param dto <b>DTO</b> with data
