...
public class CertificateServiceImpl implements CertificateService {
  ...
  public List<CertificateDto> search(
    ...
    log.debug(
        "Searching the Certificate. Tag name {}, Certificate name {}, Certificate description {}, sort {}, page № - {}, size - {}",
        tagName,
        name,
        description,
        sort,
    ...
    List<Certificate> searchResult =
        certificateDao.search(tagName, name, description, sort, page, size);
  ...
  private void deleteOrphanTags(Set<Tag> tagSet) {
    tagSet.forEach(
        tag -> {
          List<Certificate> certificateByTagId =
              certificateDao.retrieveCertificatesByTagId(tag.getId());
