...
public class CertificateDaoImpl implements CertificateDao {
    ...
    public static final String READ_CERTIFICATE_BY_ID =
    ...
    @Autowired
    public CertificateDaoImpl(JdbcTemplate jdbcTemplate, KeyHolder keyHolder, SearchProvider searchProvider) {
    ...
    public Optional<Certificate> readById(long id) {
        ...
        return jdbcTemplate.query(READ_CERTIFICATE_BY_ID, new Object[]{id}, new int[]{Types.VARCHAR},
                new BeanPropertyRowMapper<>(Certificate.class)).stream().findAny();
    }

    @Override
    public List<Certificate> search(String tagName,
                                    String name, String description, String sort) {
        log.debug("Searching Certificate. Tag name - {}, Certificate name - {}, Certificate description - {}, sort - {}",
    ...
    public Certificate create(Certificate certificate) {
        ...
        int rowsAffected = jdbcTemplate.update(connection -> {
                    PreparedStatement ps = connection
                            .prepareStatement(CREATE_NEW_CERTIFICATE, Statement.RETURN_GENERATED_KEYS);
    ...
    public List<Certificate> retrieveCertificatesByTagId(long tagId) {
        ...
        return jdbcTemplate.query(READ_CERTIFICATES_BY_TAG_ID, new Object[]{tagId}, new int[]{Types.VARCHAR},
