...
class SortFactoryImpl implements SortFactory {
    ...
    private final static Map<String, String> sortQueryFragments = new HashMap<>();
    ...
    public void addNewSortQueryFragment(String sortRequest, String sortQueryFragment) {
        log.debug("Adding for the request - {} the new sort SQL query fragment - {}",
                sortRequest, sortQueryFragment);
