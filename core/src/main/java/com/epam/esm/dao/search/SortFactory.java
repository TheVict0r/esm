...
/**
 * Class for storing and providing short pieces of SQL-query determining
 * the variables for the ordering and its direction (ascending or descending)
 */
@Component
interface SortFactory {
     ...
     *
     * @param sortRequest       request for the fragment of SQL sort code
     * @param sortQueryFragment the fragment of SQL sort code
     */
