...
/**
 * Basic interface for search methods used to provide complex Certificate search by various parameters
 */
@Component
public interface SearchProvider {

    /**
     * Constructs an SQL search query for a prepared statement to find all Certificates corresponding to the specified parameters.
     * <p>
