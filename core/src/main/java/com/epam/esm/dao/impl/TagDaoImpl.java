...
public class TagDaoImpl implements TagDao {
    ...
    private static final String SAVE_TAG_TO_CERTIFICATE = "INSERT INTO gift_certificate_tag (gift_certeficate_id, tag_id) VALUES (?, ?)";
    private static final String DELETE_TAGS_FROM_CERTIFICATE = "DELETE FROM gift_certificate_tag WHERE gift_certeficate_id = ?";
    ...
    public Optional<Tag> readById(long id) {
        ...
        return jdbcTemplate.query(READ_TAG_BY_ID, new Object[]{id}, new int[]{Types.VARCHAR}, new BeanPropertyRowMapper<>(Tag.class))
                .stream().findAny();
    }
    ...
    public Tag create(Tag tag) {
        ...
        int rowsAffected = jdbcTemplate.update(connection -> {
            PreparedStatement ps = connection.prepareStatement(CREATE_NEW_TAG, Statement.RETURN_GENERATED_KEYS);
    ...
    public Set<Tag> retrieveTagsByCertificateId(long certificateId) {
        ...
        List<Tag> tagList = jdbcTemplate.query(READ_TAGS_BY_CERTIFICATE_ID, new Object[]{certificateId}, new int[]{Types.VARCHAR},
    ...
    private Optional<Tag> readByName(String tagName) {
        ...
        return jdbcTemplate.query(READ_TAG_BY_NAME, new Object[]{tagName}, new int[]{Types.VARCHAR},
                        new BeanPropertyRowMapper<>(Tag.class))
                .stream().findAny();
    }
